...
public class MainActivity extends Activity {
    ...
    void buildScreen(){
        ...
        int sideDp=getResources().getConfiguration().screenWidthDp>=700?225:180;middle.addView(leftScroll,new LinearLayout.LayoutParams(dp(sideDp),0,0));
